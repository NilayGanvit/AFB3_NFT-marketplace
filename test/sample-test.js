...
describe("NFTMarket", function () {
  ...
  await nftMarketplace.connect(buyerAddress).createMarketSale(1, { value: autionPrice })


  await nftMarketplace.connect(buyerAddress).resellToken(1,autionPrice,{value:listingPrice})
